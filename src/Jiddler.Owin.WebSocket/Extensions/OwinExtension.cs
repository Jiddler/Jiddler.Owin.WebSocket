...
namespace Jiddler.Owin.WebSocket.Extensions {
    public static class OwinExtension {
        ...
        public static void MapWebSocketRoute<T>(this IAppBuilder app, string route,
            IServiceLocator serviceLocator = null) where T : WebSocketConnection {
        ...
        public static void MapWebSocketPattern<T>(this IAppBuilder app, string regexPatternMatch,
            ...
            app.Use<WebSocketConnectionMiddleware<T>>(serviceLocator,
                new Regex(regexPatternMatch, RegexOptions.Compiled | RegexOptions.IgnoreCase));
        }
        ...
        public static void MapWebSocketRoute<T>(this IAppBuilder app, IServiceLocator serviceLocator = null)
            ...
            if (routeAttributes.Length == 0)
                throw new InvalidOperationException(typeof(T).Name +
                                                    " type must have attribute of WebSocketRouteAttribute for mapping");
